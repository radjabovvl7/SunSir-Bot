    ...
    for uid in user_ids:
        try:
            if message.content_type == "text":
                ...
                await message.bot.send_document(uid, message.document.file_id, caption=message.caption)
            elif message.content_type == "audio":
                await message.bot.send_audio(uid, message.audio.file_id, caption=message.caption)
            count += 1
        except:
            continue
